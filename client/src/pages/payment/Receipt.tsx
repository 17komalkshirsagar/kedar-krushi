              ...
              <table className="w-full text-left border border-collapse border-gray-400">
                ...
                <tbody>
                  ...
                  <tr>
                    <td
                      colSpan={7}
                      className={`border border-gray-400 p-1 text-right font-semibold ${payment?.pendingAmount > 0 ? "text-red-600" : "text-green-600"
                        }`}
                    >
                      बाकी
                    </td>
                    <td
                      className={`border border-gray-400 p-1 font-semibold ${payment?.pendingAmount > 0 ? "text-red-600" : "text-green-600"
                        }`}
                    >
