...
<tr>
  <td colspan="9" style="border: 1px solid #999; padding: 6px; text-align: right; font-weight: bold; color: ${payment?.pendingAmount > 0 ? "red" : "green"
                    };">
    बाकी
  </td>
  <td style="border: 1px solid #999; padding: 6px; font-weight: bold; color: ${payment?.pendingAmount > 0 ? "red" : "green"
                    };">
                            ...
                            <table className="w-full text-left border border-collapse border-gray-400">
                                <thead>
                                    <tr className="bg-gray-100 text-gray-800">
                                        <th className="border border-gray-400 p-1">बिल नं (खरेदी)</th>
                                        <th className="border border-gray-400 p-1">दिनांक</th>
                                ...
                                <tbody>
                                    {payment?.products?.map((item: any) => (
                                        <tr key={item._id}>
                                            {/* <td className="border border-gray-400 p-1">{item.product.originalBillNumber ?? 'N/A'}</td> */}
                                    ...
                                    <tr>
                                        <td colSpan={8} className="border border-gray-400 p-1 text-xs">
                                            Deceleration - the Central Goods and Services Tax Act.2017 MHA-GST Act 2017
                                        </td>
                                    ...
                                    <tr>
                                        <td colSpan={9} className={`border border-gray-400 p-1 text-right font-semibold ${payment?.pendingAmount > 0 ? "text-red-600" : "text-green-600"}`}>
                                            बाकी
                                        </td>
                                        <td className={`border border-gray-400 p-1 font-semibold ${payment?.pendingAmount > 0 ? "text-red-600" : "text-green-600"}`}>
                                            ₹{payment?.pendingAmount ?? 0}/-
                                        </td>
                                    </tr>
