...
//     const totalQuantity = data.products?.reduce((acc: any, prod: any) => acc + (prod.quantity || 0), 0);
...
//                             <td className="px-2 py-1 border">{new Date(inst.paymentDate).toLocaleDateString()}</td>
