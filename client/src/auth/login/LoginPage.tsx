...
const LoginPage = () => {
  ...
  const [continueWithGoogle, { isSuccess: isGoogleSuccess, isError: isGoogleError }] = useContinueWithGoogleMutation();
  ...
  useEffect(() => {
    if (isGoogleError) {
      toast.error('  Google ErrorLogin failed. Please try again.');
